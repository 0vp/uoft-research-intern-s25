...
//    assign cumulative_metrics3[3] = e2[3]+survivor_path_metrics[3];
    ...
    (* ram_style = "block" *) reg [METRIC_RESOLUTION-1:0] reliability0 [3:0][TRACEBACK-1:0] = '{default: '0};
    (* ram_style = "block" *) reg [METRIC_RESOLUTION-1:0] reliability1 [3:0][TRACEBACK-1:0] = '{default: '0};
    (* ram_style = "block" *) reg [METRIC_RESOLUTION-1:0] reliability2 [3:0][TRACEBACK-1:0] = '{default: '0};
    (* ram_style = "block" *) reg [METRIC_RESOLUTION-1:0] reliability3 [3:0][TRACEBACK-1:0] = '{default: '0};
