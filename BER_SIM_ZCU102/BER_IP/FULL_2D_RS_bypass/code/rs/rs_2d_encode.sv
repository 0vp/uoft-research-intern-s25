...
// Implements 2D RS(31,27) encoding with row/column encoding and parity-on-parity

module rs_2d_encoder #(
    parameter N = 31,                    // Total symbols per dimension
    parameter K = 27,                    // Data symbols per dimension
...
localparam DATA_SYMBOLS = K * K;                           // 729 symbols
localparam ENCODED_SYMBOLS = N * N;                        // 961 symbols
localparam DATA_BITS = DATA_SYMBOLS * SYMBOL_WIDTH;        // 5832 bits
localparam ENCODED_BITS = ENCODED_SYMBOLS * SYMBOL_WIDTH;  // 7688 bits
