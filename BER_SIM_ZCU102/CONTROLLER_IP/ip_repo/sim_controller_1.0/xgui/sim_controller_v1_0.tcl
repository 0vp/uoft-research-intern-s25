...
proc update_PARAM_VALUE.FRAME_ERROR_STOP_CRITERION { PARAM_VALUE.FRAME_ERROR_STOP_CRITERION } {
	# Procedure called to update FRAME_ERROR_STOP_CRITERION when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.FRAME_ERROR_STOP_CRITERION { PARAM_VALUE.FRAME_ERROR_STOP_CRITERION } {
	# Procedure called to validate FRAME_ERROR_STOP_CRITERION
	return true
}
...
proc update_MODELPARAM_VALUE.FRAME_ERROR_STOP_CRITERION { MODELPARAM_VALUE.FRAME_ERROR_STOP_CRITERION PARAM_VALUE.FRAME_ERROR_STOP_CRITERION } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.FRAME_ERROR_STOP_CRITERION}] ${MODELPARAM_VALUE.FRAME_ERROR_STOP_CRITERION}
}
